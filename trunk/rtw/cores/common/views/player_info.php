...
<div class="box" style="margin-top: 20px">
    ...
    <a href="/mod/rtw/view.php?id=<?php echo $course_module->id ?>&c=lottery" style="display: block; position: relative; padding-left: 45px; padding-top: 6px; height: 30px; margin-bottom: 10px;" ><span class="icons icon_group_activity"></span>Quay số trúng thưởng (<?php echo $player_info->lottery_turn?>)</a>
