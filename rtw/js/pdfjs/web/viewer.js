...
var DEFAULT_URL = 'http://local.moodle/files/documents/pdf/a.pdf';
...
PDFJS.imageResourcesPath = '/mod/rtw/js/pdfjs/web/images/';
  PDFJS.workerSrc = '/mod/rtw/js/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = '/mod/rtw/js/pdfjs/web/cmaps/';
...
function updateViewarea() {
  ...
  // var pdfOpenParams = '#page=' + pageNumber; //buubui changed
  var pdfOpenParams = '#page=1';
