...
/**
 * The mod_rtw post created event.
 *
 * @package    mod_rtw
...
namespace mod_rtw\event;

defined('MOODLE_INTERNAL') || die();

/**
 * The mod_rtw post created event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class rtw_debug extends \core\event\base {
    private $object_data;
    /**
     * Init method.
     *
    ...
    public static function get_name() {
        return get_string('eventdebug', 'mod_rtw');
    }
    ...
    public function get_url() {
        $url = new \moodle_url('/mod/rtw/view.php', array());
        return $url;
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logurl = substr($this->get_url()->out_as_local_url(), strlen('/mod/rtw/'));

        return array($this->courseid, 'rtw', 'debug', $logurl);
    }
