<link rel="stylesheet" href="/mod/rtw/js/pdfjs/web/viewer.css"/>

<!--  -->
<div id="rtw_content" style="display: block;text-align: center">
    <div id="docviewer" style="height: 500px">
...
<script type="text/javascript">
  ...
  var PDF_URL = "<?php echo $config_rtw->paths->pdf.$doc->url?>"
</script>

<script src="/mod/rtw/js/pdfjs/web/compatibility.js"></script>

<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="/mod/rtw/js/pdfjs/web/locale/locale.properties"/>
<script src="/mod/rtw/js/pdfjs/web/l10n.js"></script>
<script src="/mod/rtw/js/pdfjs/build/pdf.js"></script>
<script src="/mod/rtw/js/pdfjs/web/debugger.js"></script>
<script src="/mod/rtw/js/pdfjs/web/viewer.js"></script>
...
function showQuestion(page) {
    $.ajax({
        ...
        cache: false,
        async: false,
        url: "/mod/rtw/ajax.php?id="+course_module+"&c=docquest&a=question&page="+page,
...
$(document).ready(function(){
    ...
    //     if($(this).scrollTop() + $(this).innerHeight() >= this.scrollHeight && !scroll_bottom) {
    //       if (max_page == 1 && $.inArray(max_page,rand_numbers)) {
